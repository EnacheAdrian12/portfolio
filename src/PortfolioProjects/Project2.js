    ...
    <div className="project1-big-div">
      ...
      <div className="project1-second-caset">
        ...
        <p className="project1-second-caset-paragraph">
          Google Copy is a replica of Google's first page. I've been watching a
          lot of youtube videos and all of them say for the beginning you have to try
          to copy some websites. Then I was thinking about what website I should
          copy and the big idea that came to my mind was " Let's copy Google's
          first page" and here I am.
        </p>
      </div>
    </div>
  </Fragment>
